...
export const TOWER_DEFS = {
  ...
  frost: {
    ...
    lvls: [
      ...
      { cost: 410, dmg: 43, rate: 1.05, range: 3.7, slow: { pct: 0.66, dur: 2.8 } },
      { cost: 920, dmg: 62, rate: 1.14, range: 4.2, slow: { pct: 0.69, dur: 3.0 } },
      { cost: 1380, dmg: 85, rate: 1.22, range: 4.45, slow: { pct: 0.71, dur: 3.2 } },
      { cost: 1940, dmg: 115, rate: 1.3, range: 4.7, slow: { pct: 0.73, dur: 3.4 } },
      { cost: 2720, dmg: 150, rate: 1.38, range: 4.95, slow: { pct: 0.75, dur: 3.6 } },
    ],
  },
  tesla: {
