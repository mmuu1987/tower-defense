...
export const TOWER_DEFS = {
  arrow: {
    ...
    lvls: [
      ...
      { cost: 340, dmg: 55, rate: 1.75, range: 4.5 },
      { cost: 780, dmg: 78, rate: 1.95, range: 5.0 },
      { cost: 1180, dmg: 108, rate: 2.1, range: 5.25 },
      { cost: 1680, dmg: 150, rate: 2.3, range: 5.5 },
      { cost: 2420, dmg: 205, rate: 2.5, range: 5.8 },
    ],
  },
  cannon: {
    ...
    lvls: [
      ...
      { cost: 500, dmg: 125, rate: 0.66, range: 3.8, splash: 2.5 },
      { cost: 1120, dmg: 180, rate: 0.72, range: 4.2, splash: 2.8 },
      { cost: 1660, dmg: 250, rate: 0.77, range: 4.5, splash: 3.0 },
      { cost: 2320, dmg: 330, rate: 0.82, range: 4.8, splash: 3.2 },
      { cost: 3260, dmg: 430, rate: 0.88, range: 5.1, splash: 3.35 },
    ],
  },
  frost: {
    key: 'frost', name: '寒霜塔', hotkey: '3', icon: './assets/textures/ui/tower_frost.png', unlockIndex: 0, cost: 90, kind: 'pulse',
    dmg: 10, rate: 0.9, range: 2.9, slow: { pct: 0.43, dur: 2.0 }, targets: 'both', damageType: 'magic', targeting: 'fastest', desc: '冰环减速周围敌人',
    lvls: [
      null,
      { cost: 80,  dmg: 18, rate: 0.95, range: 3.1, slow: { pct: 0.5, dur: 2.3 } },
      { cost: 140, dmg: 30, rate: 1.0,  range: 3.4, slow: { pct: 0.56, dur: 2.7 } },
      { cost: 410, dmg: 43, rate: 1.05, range: 3.7, slow: { pct: 0.59, dur: 2.8 } },
      { cost: 920, dmg: 62, rate: 1.14, range: 4.2, slow: { pct: 0.62, dur: 3.0 } },
      { cost: 1380, dmg: 85, rate: 1.22, range: 4.45, slow: { pct: 0.64, dur: 3.2 } },
      { cost: 1940, dmg: 115, rate: 1.3, range: 4.7, slow: { pct: 0.66, dur: 3.4 } },
      { cost: 2720, dmg: 150, rate: 1.38, range: 4.95, slow: { pct: 0.68, dur: 3.6 } },
    ],
  },
  tesla: {
    ...
    lvls: [
      ...
      { cost: 560, dmg: 68, rate: 0.96, range: 4.0, chains: 6 },
      { cost: 1250, dmg: 98, rate: 1.06, range: 4.4, chains: 7 },
      { cost: 1840, dmg: 132, rate: 1.14, range: 4.7, chains: 8 },
      { cost: 2580, dmg: 172, rate: 1.22, range: 5.0, chains: 9 },
      { cost: 3620, dmg: 220, rate: 1.3, range: 5.3, chains: 10 },
    ],
  },
  sniper: {
    ...
    lvls: [
      ...
      { cost: 620, dmg: 260, rate: 0.46, range: 8.2 },
      { cost: 1380, dmg: 360, rate: 0.5, range: 9.0 },
      { cost: 2020, dmg: 490, rate: 0.55, range: 9.4 },
      { cost: 2840, dmg: 650, rate: 0.6, range: 9.8 },
      { cost: 3980, dmg: 850, rate: 0.65, range: 10.2 },
    ],
  },
  venom: {
    ...
    lvls: [
      ...
      { cost: 430, dmg: 38, rate: 0.96, range: 4.8, poison: { damage: 7, duration: 4.6, maxStacks: 5, healBlock: 3 } },
      { cost: 820, dmg: 52, rate: 1.04, range: 5.05, poison: { damage: 9, duration: 4.8, maxStacks: 5, healBlock: 3.5 } },
      { cost: 1260, dmg: 70, rate: 1.12, range: 5.25, poison: { damage: 11, duration: 5.0, maxStacks: 6, healBlock: 4 } },
      { cost: 1780, dmg: 91, rate: 1.2, range: 5.45, poison: { damage: 13, duration: 5.2, maxStacks: 6, healBlock: 4.5 } },
      { cost: 2480, dmg: 115, rate: 1.28, range: 5.7, poison: { damage: 15, duration: 5.4, maxStacks: 6, healBlock: 5 } },
    ],
  },
  beacon: {
    ...
    aura: { damagePct: 0.07, ratePct: 0.05, skillCooldownPct: 0.04 }, desc: '区域增益火力与技能循环，不直接造成伤害',
    lvls: [
      null,
      { cost: 160, range: 4.75, aura: { damagePct: 0.09, ratePct: 0.06, skillCooldownPct: 0.05 } },
      { cost: 250, range: 5.0, aura: { damagePct: 0.11, ratePct: 0.07, skillCooldownPct: 0.06 } },
      { cost: 620, range: 5.3, aura: { damagePct: 0.13, ratePct: 0.09, skillCooldownPct: 0.07 } },
      { cost: 1080, range: 5.6, aura: { damagePct: 0.15, ratePct: 0.1, skillCooldownPct: 0.08 } },
      { cost: 1580, range: 5.9, aura: { damagePct: 0.17, ratePct: 0.11, skillCooldownPct: 0.09 } },
      { cost: 2200, range: 6.2, aura: { damagePct: 0.19, ratePct: 0.12, skillCooldownPct: 0.1 } },
      { cost: 3020, range: 6.5, aura: { damagePct: 0.2, ratePct: 0.14, skillCooldownPct: 0.12 } },
    ],
  },
};
